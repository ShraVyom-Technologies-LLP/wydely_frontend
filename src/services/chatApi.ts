...
const mockMessages: Record<string, UserChatPanel> = {
  '1': {
    messages: [
      ...
      {
        id: 'm3',
        text: "Hi! This Independence Day, we're proud to be part of your journey — just as you've been part of ours. Celebrate the spirit of our nation and enjoy special discounts on our bestsellers. 🛒 Explore our bestsellers👇",
        timestamp: '16:10',
        isFromUser: false,
        status: 'RECEIVED_READ',
        isTemplate: true,
        templateHeaderImage: {
          uri: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&h=600&fit=crop',
        },
        templateFooter: [
          {
            type: 'button',
      ...
      {
        id: 'm4',
        text: 'Hi John, your order #12345 has been confirmed! We will send you updates on your order status. Thank you for shopping with us!',
        timestamp: '16:15',
        isFromUser: true,
        status: 'SENT_DELIVERED_READ',
        isTemplate: true,
  ...
  '2': {
    messages: [
      ...
      {
        id: 'm6',
        text: 'Dear customer, this is a friendly reminder that your payment of ₹5,000 for invoice #INV-2024-001 is due on 15/01/2025. Please make the payment at your earliest convenience.',
        timestamp: '14:35',
        isFromUser: false,
